// CREO L'ARRAY DI OGGETTI CHE DOVRANNO ESSERE VISUALIZZATI NELL COURSEL
const images = [
    {
        image: 'img/01.webp',
...
images.forEach((slider, i) => {
    ...
    if (i === i) {
        sliderElement.innerHTML += `<div id="title">${images[i].title}</div>`;
        sliderElement.innerHTML += `<div id="text">${images[i].text}</div>`;
    }
...
document.querySelector("#slider #title").className = "active";
document.querySelector("#slider #text").className = "active";
...
document.querySelector("#up-arrow").addEventListener("click", function () {
    ...
    if (slideNumber < images.length) {
        ...
        document.querySelector(`#slider .text:nth-of-type(${slideNumber})`).classList.remove("active");
        document.querySelector(`#slider #title`).classList.remove("active");
        ...
        document.querySelector(`#slider .text:nth-of-type(${slideNumber})`).classList.add("active");
        document.querySelector(`#slider #title`).classList.add("active");
